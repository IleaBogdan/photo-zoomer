...
os.listdir('ass-at') # this shit will break the app if removed, DO NOT REMOVE
...
def save_compression_levels(np_image: np.array, filename: str, exit_w_dim: int = 1920, exit_h_dim: int = 1080):
    ...
    for zoom_level in range(1, max_zoom+1):
        ...
        with open("compression_step.txt", "a") as file:
            file.write(f"{step_x} - {step_y}\n")
...
if __name__=="__main__":
    ...
    save_compression_levels(np_rgb_image, f"{folder}/test")
